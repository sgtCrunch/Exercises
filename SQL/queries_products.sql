...
-- Display only the products that have
-- a price in between 22.50 and 99.99.
SELECT name FROM products WHERE price BETWEEN 22.50 and 99.99;

-- There’s a sale going on: 
-- Everything is $20 off! Update the database accordingly.

UPDATE products SET price = price * .8;

-- Because of the sale, everything that costs less than $25 has
-- sold out. Remove all products whose price meets this criteria.
